    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passport_img', models.ImageField(null=True, upload_to='client_images/.2023-08-18.12-39-41')),
                ('room_type', models.CharField(max_length=100)),
                ('total_amount', models.DecimalField(decimal_places=2, max_digits=20)),
                ('remained_amount', models.DecimalField(decimal_places=2, max_digits=20)),
                ('visa_file', models.FileField(null=True, upload_to='visa_files/.2023-08-18.12-39-41')),
                ('is_badge', models.BooleanField(default=False)),
                ('outfit_size', models.CharField(max_length=50, null=True)),
                ('human_development', models.CharField(choices=[('Infant', 'Infant'), ('Child', 'Child'), ('Adult', 'Adult')], max_length=100, null=True)),
                ('gender_type', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('series', models.CharField(max_length=100)),
                ('series_number', models.PositiveIntegerField()),
                ('passport_img', models.ImageField(null=True, upload_to='visa_client_pass_imgs/.2023-08-18.12-39-41')),
                ('room_type', models.CharField(max_length=100)),
                ('total_amount', models.DecimalField(decimal_places=2, max_digits=20)),
                ('remained_amount', models.DecimalField(decimal_places=2, max_digits=20)),
                ('visa_file', models.FileField(null=True, upload_to='visa_client_files/.2023-08-18.12-39-41')),
                ('is_badge', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('series', models.CharField(max_length=100)),
                ('series_number', models.PositiveIntegerField()),
                ('passport_image', models.ImageField(null=True, upload_to='visa_partner_pass_imgs/.2023-08-18.12-39-41')),
                ('total_amount', models.DecimalField(decimal_places=2, max_digits=20)),
                ('remained_amount', models.DecimalField(decimal_places=2, max_digits=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('series', models.CharField(max_length=100)),
                ('series_number', models.PositiveIntegerField()),
                ('passport_image', models.ImageField(null=True, upload_to='pass_partner_images/.2023-08-18.12-39-41')),
                ('total_amount', models.DecimalField(decimal_places=2, max_digits=20)),
                ('remained_amount', models.DecimalField(decimal_places=2, max_digits=20)),
                ('visa_file', models.FileField(null=True, upload_to='pass_visa_files/.2023-08-18.12-39-41')),
                ('is_badge', models.BooleanField(default=False)),
                ('outfit_size', models.CharField(max_length=50, null=True)),
